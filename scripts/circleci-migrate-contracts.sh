...
echo "scp utilitybox:/tmp/$BUILD_TAG/build/contracts/* /tmp/sortition-pools/contracts"
scp utilitybox:/tmp/$BUILD_TAG/build/contracts/* /tmp/sortition-pools/contracts
